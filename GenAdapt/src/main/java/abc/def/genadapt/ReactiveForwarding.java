...
public class ReactiveForwarding {
    ...
    public void activate(ComponentContext context) {
        ...
        appId = coreService.registerApplication("abc.def.dices.2");
        ...
        ////////////////////////////////////////////////////////////////////////
        dynamicAdaptiveControlTask.setDeviceService(deviceService);
        dynamicAdaptiveControlTask.setLinkService(linkService);
        dynamicAdaptiveControlTask.setFlowRuleService(flowRuleService);
        dynamicAdaptiveControlTask.setHostService(hostService);
        dynamicAdaptiveControlTask.setTopologyService(topologyService);
        dynamicAdaptiveControlTask.setFlowObjectiveService(flowObjectiveService);
    ...
    public void deactivate() {
        ...
        ////////////////////////////////////////////////////////////////////////
        ////////////////////////////////////////////////////////////////////////
        dynamicAdaptiveControlTask.setExit(true);
        dacTimer.cancel();
        ////////////////////////////////////////////////////////////////////////
        ////////////////////////////////////////////////////////////////////////
        ////////////////////////////////////////////////////////////////////////
    ...
    private class ReactivePacketProcessor implements PacketProcessor {
        ...
        public void process(PacketContext context) {
            ...
            ////////////////////////////////////////////////////////////////////
            //////////////////////////////////////////////////////////////////
            abc.def.genadapt.SrcDstPair sdPair = new abc.def.genadapt.SrcDstPair(macAddress, id.mac());
    ...
    private void logPath(Set<Path> paths) {
        for (Path p : paths) {
            for (Link l : p.links()) {
                log.info("Link: {} -> {}", l.src().deviceId(), l.dst().deviceId());
            }
        }
    }
    ...
    private void installRule(PacketContext context, PortNumber portNumber, ReactiveForwardMetrics macMetrics) {
        ...
        ForwardingObjective forwardingObjective = DefaultForwardingObjective.builder()
                ...
                .add();
        if (Config.test) {
            log.info("INSTALL: " + " src: " + inPkt.getSourceMAC() + " dst: " + inPkt.getDestinationMAC() + " device id: " + context.inPacket().receivedFrom().deviceId() + " inPort: " + context.inPacket().receivedFrom().port() + " outPort: " + portNumber);
